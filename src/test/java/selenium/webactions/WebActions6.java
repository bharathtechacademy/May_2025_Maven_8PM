...
//		5. Verify application title
		...
		Reports.startReporting("Verify Logo and Caption");
		
//		6. Verify application logo
		WebElement logo = driver.findElement(By.xpath("//img[@class='logo']"));
		Assert.assertTrue(logo.isDisplayed(), "Logo is not displayed");
		Reports.logger.pass("Logo is displayed successfully");
...
//		7. Verify application caption
		...
		Reports.logger.pass("Caption is matching successfully");
		Reports.logger.addScreenCaptureFromPath(takeScreenshot(logo,"Logo"));
		Reports.logger.info("Execution completed");
		Reports.stopReporting();


		Reports.startReporting("Verify Login Functionality");
...
//		8. Enter Invalid credentials in Username and Password textboxes
		...
		Reports.logger.info("Username and Password successfully updated");

		
//		clear the textbox
		usernameTxtb.clear();
		passwordTxtb.clear();
		Reports.logger.info("Username and Password textboxes cleared");
...
//		9. Click on Login Button
		...
		loginButton.click();
		Reports.logger.info("Clicked on the Login Button");
...
//		10. Verify error message is displayed (The username and password could not be verified.)
		...
		Reports.logger.fail("Error message is coming, Login Failed");
		Reports.logger.addScreenCaptureFromPath(takeScreenshot(driver,"Error"));
		Reports.logger.info("Execution completed");
		Reports.stopReporting();
